...
@export var player_worms : int = 0
@export var first_path_node : Node2D = null
@export var enemy_spawner : Node = null
@export var player_money : int = 0
@export var wave_start_button : Button = null
@export var pause_button : Button = null
@export var player_health: Label = null
...
@export var player_money_label: Label = null
@export var wave_counter: Label = null
@export var worm_spawn_node: Node = null # This is just set to 2nd node for now for testing
@export var worm_path_node: Node = null # Again debug
...
@onready var current_hp: int = starting_hp
