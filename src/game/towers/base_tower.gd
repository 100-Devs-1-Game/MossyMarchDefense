...
var attack_dictionary = {
	GlobalEnums.TowerType.PlantPot: preload("res://game/towers/attacks/debug_attack.tscn"),
	GlobalEnums.TowerType.WateringCan: preload("res://game/towers/attacks/debug_attack.tscn"),
}
